...
public class MenuGrid extends Widget implements KeyBinding.Bindable {
    ...
    protected void attach(UI ui) {
        ...
        synchronized (paginae) {
            ...
            //p.add(paginafor(Resource.local().load("paginae/amber/townspeaker")));
    ...
    public void use(String[] ad) {
        ...
        } else if (ad[1].equals("cheesetray-slice")) {
            new Thread(new SliceCheeseTray(gui), "SliceCheeseTray").start();
